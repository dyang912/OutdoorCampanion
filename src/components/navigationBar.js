            ...
            <ul className="navbar-nav flex-row">
                <li className = "nav-item mx-5">
                    <Link to={"/"} className= "nav-link">
                        { location.pathname === "/" ?
                            <i className="bi bi-house-fill" style={{fontSize:"25px"}}/> :
                            <i className="bi bi-house" style={{fontSize:"25px"}}/> }
                    </Link>
                </li>
                <li className = "nav-item mx-5">
                    <Link to={"/newpost"} className= "nav-link">
                        { location.pathname === "/newpost" ?
                            <i className="bi bi-plus-square-fill" style={{fontSize:"25px"}}/> :
                            <i className="bi bi-plus-square" style={{fontSize:"25px"}}/> }
                    </Link>
                </li>
                <li className = "nav-item mx-5">
